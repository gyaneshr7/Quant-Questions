          ...
          user ?
            ...
            loc === '/login' || loc === '/signup' ?
              <div className='right'>
                ...
                <Link to='/Admin'><button className='que-btn' onClick={() => { setClicked(true) }}>Admin</button></Link>
              </div>
              :
              <div className='right'>
