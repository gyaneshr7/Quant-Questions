...
function Questions() {
  ...
  const columnlogin = [
    ...
    },
    {
      ...
      cell: row => <Link to='/quedetail' state={{ id: row.uniqueId }}><div style={{ fontSize: 15, color: "#0378a6", fontWeight: 600, cursor: "pointer" }}>{row.title}</div></Link>,
      width: "300px",
      sortable: true
    },
    {
      ...
      <div>
        <div className="quest-block">
          <div className="div1">
            ...
            <Link to='/quedetail' state={{ id : random && data[random].uniqueId }}><button className="random">Random Q</button></Link>
            </div>
          </div>
